  ...
  return (
    <div className="flex justify-center mb-8 w-full">
        <div className="relative w-full" data-te-input-wrapper-init>
            ...
            />
            <label
                className="text-frenchGray pointer-events-none absolute top-0 left-2 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none"
                >{title}
            </label>
            <div
